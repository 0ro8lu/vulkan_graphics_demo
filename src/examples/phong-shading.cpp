...
private:
  ...
  void createDescriptorSetLayout()
  {
    ...
    std::array<VkDescriptorSetLayoutBinding, 7> bindings = {
      staticUBOLayoutBinding,        dynUBOLayoutBinding,
      diffuseSamplerLayoutBinding,   specularSamplerLayoutBinding,
      directionalLightLayoutBinding, pointLightLayoutBinding,
  ...
  void createGraphicsPipelines()
  {
    ...
    createPipeline(shaderPath + "phong-shading/built/texture_vert.spv",
                   shaderPath + "phong-shading/built/texture_frag.spv",
                   mainPipelineLayout,
                   mainGraphicsPipeline);
    createPipeline(shaderPath + "phong-shading/built/light_cube_vert.spv",
                   shaderPath + "phong-shading/built/light_cube_frag.spv",
  ...
  void prepareTextures()
  {
    ...
    createTextureImage(texturePath + "diffuse.png",
                       diffuseTextureImage,
                       diffuseTextureAllocation);
    ...
    createTextureImage(texturePath + "specular.png",
  ...
  void createDescriptorPool()
  {
    ...
    // static_cast<uint32_t>(MAX_FRAMES_IN_FLIGHT); poolSizes[4].type =
    // VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER; poolSizes[4].descriptorCount =
    // static_cast<uint32_t>(MAX_FRAMES_IN_FLIGHT) * 3; poolSizes[5].type =
    // VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER; poolSizes[5].descriptorCount =
    // static_cast<uint32_t>(MAX_FRAMES_IN_FLIGHT) * 2; poolSizes[6].type =
    // VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER; poolSizes[6].descriptorCount =
  ...
  void createDescriptorSets()
  {
    ...
    for (size_t i = 0; i < MAX_FRAMES_IN_FLIGHT; i++) {
      ...
      descriptorWrites[5].dstSet = globalDescriptorSets[i];
      ...
      descriptorWrites[6].dstSet = globalDescriptorSets[i];
