...
public:
	...
	void setPos(glm::vec3 newPosition) { cameraPos = newPosition; needsUpdating = true; }
	void setDirection(glm::vec3 newDirection) { cameraFront = newDirection; needsUpdating = true; }
